...
export const CurrentQuestion: FC<CurrentQuestionProps> = ({setCurrentNode, currentNode, setTestIsOver, setSelectedLang}) => {
    ...
    return (
        <div className={"rounded-lg overflow-hidden flex flex-col justify-between shadow-xl shadow-gray-900/20 w-full"}>
            ...
            <div className={"flex justify-between cursor-pointer"}>
                <button
                    className={"p-4 w-1/2 flex justify-center bg-green-500 hover:bg-green-600 ease-in duration-100"}
                    onClick={() => setNextQuestionHandler("yes")}
                >
                    Да
                </button>
                <button
                    className={"p-4 w-1/2 flex justify-center bg-pink-500 hover:bg-pink-600 ease-in duration-100"}
